# Verification plan — Sid Meier's Civilization VI

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Turn economy worksheets

- [ ] Define a versioned input fixture specifically for turn economy worksheets.
...
### 2. Technology route comparisons

- [ ] Define a versioned input fixture specifically for technology route comparisons.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Ruleset compatibility notes

- [ ] Define a versioned input fixture specifically for ruleset compatibility notes.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
