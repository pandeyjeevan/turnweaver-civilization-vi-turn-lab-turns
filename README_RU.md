...
<div align="center">
  <img src="./public/logo.svg" alt="TurnWeaver — Sid Meier&apos;s Civilization VI — Turns" width="64" height="64">
  <h1>TurnWeaver — Sid Meier&apos;s Civilization VI — Turns</h1>
</div>

Проект лаборатории одиночных сценариев экономики и развития по ходам.
...
- **Turn economy worksheets** — запланированный модуль; реализации нет.
- **Technology route comparisons** — запланированный модуль; реализации нет.
- **Ruleset compatibility notes** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Turn economy worksheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TurnWeaver — Sid Meier&apos;s Civilization VI — Turns — specification review workflow">
<br>
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Sid Meier's Civilization VI, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Technology route comparisons

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Sid Meier's Civilization VI, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Ruleset compatibility notes

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Sid Meier's Civilization VI, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Sid Meier's Civilization VI |
...
| Планируемый результат | Turn economy worksheets |
